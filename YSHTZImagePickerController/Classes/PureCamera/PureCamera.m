...
+ (UIImage *)dy_imageNamedFromMyBundle:(NSString *)name {
    
    NSBundle *imageBundle = [NSBundle PureCamera_imagePickerBundle];
...
- (void)viewDidLoad
{
    ...
    [self.snapButton setImage:[UIImage dy_imageNamedFromMyBundle:@"cameraButton"] forState:UIControlStateNormal];
    ...
    //     UIImage *image = [UIImage dy_imageNamedFromMyBundle:@"camera-flash.png"];
    [self.flashButton setImage:[UIImage dy_imageNamedFromMyBundle:@"camera-flash"] forState:UIControlStateNormal];
    ...
    if([LLSimpleCamera isFrontCameraAvailable] && [LLSimpleCamera isRearCameraAvailable]) {
        ...
        [self.switchButton setImage:[UIImage dy_imageNamedFromMyBundle:@"swapButton"] forState:UIControlStateNormal];
        [self.switchButton addTarget:self action:@selector(switchButtonPressed:) forControlEvents:UIControlEventTouchUpInside];
        [self.view addSubview:self.switchButton];
        //返回按钮
        self.backButton = [UIButton buttonWithType:UIButtonTypeCustom];
        
        [self.backButton setImage:[UIImage dy_imageNamedFromMyBundle:@"closeButton"] forState:UIControlStateNormal];
