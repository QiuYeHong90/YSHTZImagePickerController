...
+ (NSBundle *)tz_imagePickerBundle {
    ...
    NSURL *url = [bundle URLForResource:@"YSHTZImagePickerController" withExtension:@"bundle"];
...
+ (NSBundle *)PureCamera_imagePickerBundle {
    NSBundle *bundle = [NSBundle bundleForClass:[TZImagePickerController class]];
    NSURL *url = [bundle URLForResource:@"YSHTZImagePickerController" withExtension:@"bundle"];
    bundle = [NSBundle bundleWithURL:url];
    url = [bundle URLForResource:@"PureCamera" withExtension:@"bundle"];
    bundle = [NSBundle bundleWithURL:url];
